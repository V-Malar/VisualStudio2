...
export default function CDisplay({array}) {
    // console.log(arr, 'valavav');
    ...
    return (
        <div>
                            ...
                            arr.map((val, index) => {
                                return (
                                    <div key={index} className="no">
                                        {
                                            <>
                                             <label key={index} onClick={()=>{console.log(val); setText1(val);setText2(val)}}>{val[0]}</label>
                                             <br/>
                                             <label className="topmove" key={index} onClick={()=>{console.log(val); setText1(val);setText2(val)}}>{val[1]}</label>
                                             </>
                                        }
                                    </div>
                                )
            ...
            <p><span className="thickadd" onClick={() => {setCalendar("initial");document.documentElement.scrollTop = 0; // For Chrome, Firefox, IE and Opera
