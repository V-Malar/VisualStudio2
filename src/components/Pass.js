...
function Pass() {
  ...
  return (
    <div>
      <h1 style={{position: "absolute", top: "1in", left: "2.1in", zIndex: 2, color: "white"}} onClick={() => handleClick(2023)}>2023</h1>
      <h1 style={{position: "absolute", top: "1in", left: "3.8in", zIndex: 2, color: "white"}} onClick={() => handleClick(2024)}>2024</h1>
      <h1 style={{position: "absolute", top: "1in", left: "5.5in", zIndex: 2, color: "white"}} onClick={() => handleClick(2025)}>2025</h1>
